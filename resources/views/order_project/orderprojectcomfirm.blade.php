...
<div class="container mt-4" style="margin-bottom: 45px">
    ...
    <div class="col-6">
      ...
      <div class="d-flex justify-content-around mt-5 bg-warning p-3 rounded">
        <button class="btn btn-outline-primary" type="button" data-bs-toggle="offcanvas"
          data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">BANK TRANSFER/ATM DEPOSIT</button>
  ...
  <form action="/orderproject/submit/{{auth()->user()->id}}" method="post">
    ...
    <div class="d-flex justify-content-center mt-5">
      ...
      @elsecan('nopayment')
      <h6 style="margin-bottom: 20px" class="fw-bold">NO PAYMENT</h6>
      @endcan
    </div>
  </form>
</div>
